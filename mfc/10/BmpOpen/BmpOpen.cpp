...
// BmpOpen.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CBmpOpenApp, CWinApp)
ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CBmpOpenApp

CBmpOpenApp::CBmpOpenApp() {
...
// Единственный объект CBmpOpenApp

CBmpOpenApp theApp;


// Инициализация CBmpOpenApp

BOOL CBmpOpenApp::InitInstance() {
